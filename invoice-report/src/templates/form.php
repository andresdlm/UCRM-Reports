                    ...
                    <div class="card-body">
                        <form id="report-form">
                            <div class="form-row align-items-end">
                                ...
                                <div class="col-3">
                                    <label class="mb-0" for="frm-since"><small>Fecha de vencimiento desde:</small></label>
                                ...
                                <div class="col-3">
                                    <label class="mb-0" for="frm-until"><small>Fecha de vencimiento hasta:</small></label>
